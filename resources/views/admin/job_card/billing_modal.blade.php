    ...
    <div class="billing-modal">
        ...
        <div class="modal-body bg-white px-4">
            ...
            <div class="summary-box">
                <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="billing_invoice_no" class="billing-input border-danger mb-2" placeholder="Enter Bill #" required>
                ...
                <table class="table billing-table">
                    ...
                    <tbody id="billing_tbody">
                        <tr class="bill-row">
                            ...
                            <td><input type="text" name="items[0][description]" value="{{ $job_card->name_of_job }}" class="billing-input" placeholder="Description of Goods" required></td>
                        ...
                        <!-- Cylinder Charges Row Template (Can be changed/deleted) -->
                        <tr class="bill-row">
                            <td class="align-middle text-center p-1">
                                <button type="button" class="btn btn-sm btn-outline-danger remove-row"><i class="fa fa-times"></i></button>
                            </td>
                            <td><input type="text" name="items[1][description]" value="Cylinder Charges" class="billing-input" placeholder="Description of Goods"></td>
                            <td><input type="number" step="0.001" name="items[1][qty]" class="billing-input amount-calc row-qty" placeholder="0.000"></td>
                            <td>
                                <select name="items[1][unit]" class="billing-input">
                                    <option value="Pcs">Pcs</option>
                                    <option value="Kgs">Kgs</option>
                                    <option value="Set">Set</option>
                                </select>
                            </td>
                            <td><input type="number" step="0.01" name="items[1][rate]" class="billing-input amount-calc row-rate" placeholder="0.00"></td>
                            <td><input type="number" step="0.01" name="items[1][amount]" class="billing-input row-amount" readonly placeholder="0.00"></td>
                            <td>
                                <select name="items[1][gst_percent]" class="billing-input amount-calc row-gst">
                                    <option value="0">0%</option>
                                    <option value="5">5%</option>
                                    <option value="12">12%</option>
                                    <option value="18">18%</option>
                            ...
                            <td><input type="number" step="0.01" name="items[1][total_amount]" class="billing-input fw-bold row-total" readonly placeholder="0.00"></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
            ...
            <div class="row mt-3 mb-2">
                <div class="col-md-12">
                    <label class="summary-label">Remarks for Account Department</label>
                    <textarea name="remarks" class="billing-input" rows="2" placeholder="Enter any billing notes or adjustments here..."></textarea>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        if($('#bill_weight_0').val() > 0) {
            $('.amount-calc').trigger('input');
        }
    });
