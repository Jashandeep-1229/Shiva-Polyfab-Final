...
@section('breadcrumb-items')
    <li class="breadcrumb-item">Bopp Master</li>
@endsection
...
@section('script')
    <script>
        ...
        function change_status(id){
            var url = "{{route('bopp.change_status',":id")}}";
            url = url.replace(':id',id);
            $.get(url, function(data){
                if(data.result == 1){
