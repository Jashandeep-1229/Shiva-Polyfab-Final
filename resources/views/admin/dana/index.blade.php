...
@section('breadcrumb-items')
    <li class="breadcrumb-item">Dana Master</li>
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="card" id="add_type">
                    <form action="{{route('dana.store')}}" method="POST" id="" class="modal-content" enctype="multipart/form-data">
                        @csrf
...
@section('script')
    <script>
        ...
        function edit_modal(id,key_value){
            var url = "{{route('dana.edit_modal',":id")}}";
        ...
        function change_status(id){
            var url = "{{route('dana.change_status',":id")}}";
            url = url.replace(':id',id);
            $.get(url, function(data){
                if(data.result == 1){
